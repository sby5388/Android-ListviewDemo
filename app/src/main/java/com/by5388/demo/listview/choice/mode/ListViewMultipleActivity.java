...
public class ListViewMultipleActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_view_multiple);
        mListView = findViewById(android.R.id.list);
        final MyAdapter adapter = new MyAdapter(android.R.layout.simple_list_item_multiple_choice);
